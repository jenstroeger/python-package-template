...
# Build a Simple Repository directory inside of dist/. For details on the layout of that directory
# and the normalized project name, see:
#
#  - PEP-503: https://peps.python.org/pep-0503/
#    Related discussion: https://discuss.python.org/t/what-would-it-look-like-to-deprecate-pep-503/
#  - PEP 691: https://peps.python.org/pep-0691/
#
# The directory can then be used to install (hashed) artifacts by using `pip` and its `--extra-index-url`
# argument: https://pip.pypa.io/en/stable/cli/pip_install/#cmdoption-extra-index-url
PROJECT_NAME := $(shell python -c $$'import re; print(re.sub(r"[-_.]+", "-", "$(PACKAGE_NAME)").lower());')
.PHONY: simple-index-pep503 simple-index-pep691
simple-index-pep503: dist/$(PACKAGE_NAME)-$(PACKAGE_VERSION)-py3-none-any.whl dist/$(PACKAGE_NAME)-$(PACKAGE_VERSION).tar.gz
...
simple-index-pep691: dist/$(PACKAGE_NAME)-$(PACKAGE_VERSION)-py3-none-any.whl dist/$(PACKAGE_NAME)-$(PACKAGE_VERSION).tar.gz
	mkdir -p dist/simple-index/$(PROJECT_NAME)

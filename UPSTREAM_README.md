...
In the future, the generated `requirements.txt` file with its integrity hashes for each dependent package will become an important provenance material to provide transparency in the packaging process (see also [SBOM + SLSA](https://slsa.dev/blog/2022/05/slsa-sbom)).

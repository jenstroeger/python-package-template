...
- Create a [Personal Access Token](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/creating-a-personal-access-token) for your Github user account with [`repo` scope](https://docs.github.com/en/developers/apps/building-oauth-apps/scopes-for-oauth-apps#available-scopes), and then create a secret for the new Github repository with the name `REPO_ACCESS_TOKEN` whose value is that new token (see also [here](https://github.com/relekang/python-semantic-release/issues/311#issuecomment-1157270026) for how to do that). That secret is important for some of the [Github Workflows](https://github.com/jenstroeger/python-package-template/tree/main/.github/workflows) of this repository.
